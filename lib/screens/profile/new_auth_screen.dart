...
class NewAuthenticationScreen extends StatefulWidget {
  const NewAuthenticationScreen({Key? key}) : super(key: key);

  @override
  State<NewAuthenticationScreen> createState() => _NewAuthenticationScreenState();
}

class _NewAuthenticationScreenState extends State<NewAuthenticationScreen> {
        ...
        if (state is EstablishConnectionSuccess) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute<void>(
              builder: (BuildContext context) => ReturnScreen(
