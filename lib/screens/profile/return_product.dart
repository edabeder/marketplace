  ...
  void payShopping() async {
    ...
    await context
        ...
        EthereumAddress.fromHex(
            "0x3F3f8C25cff70508A7F48Da0EB7EECa38330C5ad"),
        "hello",
        BigInt.from(20))
        .then((value) => cartList = []);
  }
...
/*                                  return ElevatedButton.icon(
                                    ...
                                    label: const Text('aaaaaaaaaaaaaaaaa'),
                                  );*/
                                }
                                return Column(
                                  children: [
...
/*                                    showCreateContractButton
                                    ...
                                    ElevatedButton(
                                      onPressed: () {
                                        // Navigate back to the previous screen on button press
                                        Navigator.pop(context);
                                      },
                                      style: buttonStyle,
                                      child: const Text("Go Back to Orders Screen"),
                                    ),
                                  ],
                                );
                              },
